...
public class SubtractionDescriptionInflater extends ADescriptionInflater {
    ...
    public void fillDescription(TextView tv) {
        ...
        tv.append(Helper.insertStringToStart(temp, Helper.paintString(
                mResources.getString(R.string.subtraction), R.color.green, tv))
                .append("\n"));

        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(mContext);

        String type = mKindPrefMap.get(pref.getString(SubtractionFactory.KIND_KEY, SubtractionFactory.DEF_VAL_FOR_KIND));
        ...
        String amount = mAmountPrefMap.get(pref.getString(SubtractionFactory.AMOUNT_KEY, SubtractionFactory.DEF_VAL_FOR_AMOUNT));
        ...
        String vistime = mVisTimePrefMap.get(pref.getString(SubtractionFactory.VISTIME_KEY, SubtractionFactory.DEF_VAL_FOR_VISTIME));
        ...
        String format = mFormatPrefMap.get(pref.getString(SubtractionFactory.FORMAT_KEY, SubtractionFactory.DEF_VAL_FOR_FORMAT));
        ...
        Boolean isHonest = pref.getBoolean(SubtractionFactory.HONESTMODE_KEY, SubtractionFactory.DEF_VAL_FOR_HONESTMODE);
        ...
        Boolean showStopwatch = pref.getBoolean(SubtractionFactory.STOPWATCH_MODE_KEY, SubtractionFactory.DEF_VAL_FOR_STOPWATCHMODE);
    ...
    protected void fillMaps() {
        ...
        listOfValues = mResources.getStringArray(R.array.subtractionTrainString);
        listOfIds = mResources.getStringArray(R.array.subtractionTrainStringId);
